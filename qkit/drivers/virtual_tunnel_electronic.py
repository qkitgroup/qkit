...
class virtual_tunnel_electronic(Instrument):
    ...
    def __set_defaults_docstring(self):
        ...
        None
        '''
        new = 'pseudo bias mode: {:d}:\n'.format(self._pseudo_bias_mode) + ''.join(['\t\t{:s}: {:1.2e}\n'.format(key_parameter, val_parameter) for key_parameter, val_parameter in self._defaults[self._pseudo_bias_mode].items()])
