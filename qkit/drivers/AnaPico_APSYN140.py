...
# Viktor Adam <Viktor.adam@kit.edu> 10/11/23
#
...
class AnaPico_APSYN140(Instrument):
    ...
    def __init__(self, name, address, reset=False):
        ...
        self._visainstrument = visa.instrument('TCPIP::'+self._address+"::INSTR")
        ...
        self.add_parameter('power',
            flags=super().FLAG_GETSET, units='dBm', minval=-30, maxval=30,
            channels=(1, self._numchannels), channel_prefix='ch%d_', type=float)
        self.add_parameter('frequency',
            flags=super().FLAG_GETSET, units='Hz', minval=1e5, maxval=43.5e9,
            channels=(1, self._numchannels), channel_prefix='ch%d_', type=float)
        ...
        self.idn = self._visainstrument.query('*IDN?')
        print(f"\nHello, I am: {self.idn}")
