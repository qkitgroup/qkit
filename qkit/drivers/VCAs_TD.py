...
class VCAs_TD(Instrument):
    ...
    def __init__(self, name, address="tcp://10.22.197.143:4242"):
        ...
        self.add_parameter('attenuation_i_manip', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=0,
                           maxval=20)
        self.add_parameter('attenuation_q_manip', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=0,
                           maxval=20)
        self.add_parameter('attenuation_i_readout', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=0,
                           maxval=20) 
        self.add_parameter('attenuation_q_readout', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=0,
                           maxval=20)
        self.add_parameter('attenuation_rf_readout', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=0,
                           maxval=30)
        self.add_parameter('attenuation_rf_manip', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=0,
                           maxval=30)
        self.add_parameter('amplification_i_return', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=-20,
                           maxval=33)
        self.add_parameter('amplification_q_return', type=float, flags=Instrument.FLAG_GETSET, units='dB', minval=-20,
                           maxval=33)                                                               
    ...
    def do_get_attenuation_i_manip(self):
        """
        returns the attenuation of the vca for the I component of the manipulation signal after AWG
        """
        return True
    ...
    def do_get_attenuation_q_manip(self):
        """
        returns the attenuation of the vca for the Q component of the manipulation signal after AWG
        """
        return True
    ...
    def do_get_attenuation_i_readout(self):
        """
        returns the attenuation of the vca for the I component of the readout signal after AWG
        """
        return True
    ...
    def do_get_attenuation_q_readout(self):
        """
        returns the attenuation of the vca for the Q component of the readout signal after AWG
        """
        return True
    ...
    def do_get_attenuation_rf_readout(self):
        """
        returns the attenuation of the vca for the RF-readout signal after AWG and Mixer, before cryo
        """
        return True
    ...
    def do_get_attenuation_rf_manip(self):
        """
        returns the attenuation of the vca for the RF-manipulation signal after AWG and Mixer, before cryo
        """
        return True
    ...
    def do_get_amplification_i_return(self):
        """
        returns the amplification or attenuation of the vca for the I-signal after cryo and Mixer, before detection with ADC. The device can attenuate and amplify!
        """
        return True
    ...
    def do_get_amplification_q_return(self):
        """
        returns the amplification or attenuation of the vca for the Q-signal after cryo and Mixer, before detection with ADC. The device can attenuate and amplify!
        """
        return True                      