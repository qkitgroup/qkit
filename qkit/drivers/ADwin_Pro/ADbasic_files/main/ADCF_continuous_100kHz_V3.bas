...
'<Header End>
'Process writes 100kHz ADC input 1 values each event (333Hz) to memory of ADwin. Each value is an average of 16 measurements.  
...
LowInit:
  ...
  P2_Burst_Init(module, 1, 0, max_val, 1000, 010b)         '10 000ns per sample, 100 kHz
