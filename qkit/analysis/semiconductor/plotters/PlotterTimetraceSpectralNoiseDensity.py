...
class PlotterTimetraceSpectralNoiseDensity(SemiFigure):
    ...
    def plot(self, settings:dict, data:dict, fit_params_plunger_in=None, fit_vals=None, savename=None, xlim:list=None, ylim:list=None, dotsize=0.5, fiftyHz:bool=False):
        ...
        self.ax.plot(data["freq"], np.sqrt(data["spectrogram"] / np.abs(fit_params_plunger['fit_coef'][0])), "ok", markersize=dotsize)
