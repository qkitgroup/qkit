...
class ZI_HDAWG4_ADwin_Pro2_backend_2(MA_backend_base):
    ...
    def load_waveform(self, wave_data):
        ...
        dict_core0 = {k: wave_data.get(k) for k in channels_core0 if k in wave_data}
        ...
        dict_core1 = {k: wave_data.get(k) for k in channels_core1 if k in wave_data}
