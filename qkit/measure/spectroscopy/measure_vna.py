...
class spectrum(object):
	...
	def set_x_parameters(self, x_vec, x_coordname, x_instrument, x_unit = ""):
		'''
		specify an array of vectors, a coordinate name (str) and pass an object that is executed after each iteration
		'''
		self.x_vec = x_vec
	...
	def measure_1D2(self):
		'''
		measure full window of awg while sweeping one parameter x
		'''
	...
	def measure_2D(self):
		'''
		measure central point of awg window while sweeping parameters x,y
