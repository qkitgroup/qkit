...
class IQ_Mixer(Instrument):
    ...
    def recalibrate(self,dcx,dcy,x,y,phaseoffset,relamp,relamp2):
        ...
        print "Recalibrating %s for Frequency: %.2fGHz (MW-Freq: %.2fGHz), MW Power: %.2fdBm"%(self.mixer_name,self._sideband_frequency/1e9,mw_freq/1e9,self._mw_power)
        sys.stdout.flush()
    ...
    def calibrate(self,recalibrate=True,frequency=None,power=None,iq_frequency=None):
        ...
        try: 
            ...
            return (self._sample.f01,self._sample.f01-self._sample.iq_frequency,self._sample.mw_power,0,0,0,0,0,np.pi,1.,1.,-99,-99,-99,-99,-99)
