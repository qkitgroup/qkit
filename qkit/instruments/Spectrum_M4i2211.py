# M4i2211.py driver class, to perform the communication between the Wrapper and the card
# Julius Krause <julius.krause@student.kit.edu> 2016
# adepted from
# M2I2030.py driver class
...
class Spectrum_M4i2211(Instrument):
    ...
    Usage:
    Initialize with
    <name> = instruments.create('name', 'Spectrum_M4i2211')
    ...
    def __init__(self, name):
        ...
        self.add_parameter('input_path_ch0', flags=Instrument.FLAG_GETSET, type=types.IntType)
        self.add_parameter('input_path_ch1', flags=Instrument.FLAG_GETSET, type=types.IntType)
        ...
        self.add_parameter('loops', flags=Instrument.FLAG_GETSET, type=types.IntType)
        self.add_parameter('trigger_ext0_level0', flags=Instrument.FLAG_SET, type=types.IntType, minval=-5000, maxval=5000, unit='mV')
        self.add_parameter('trigger_ext0_level1', flags=Instrument.FLAG_SET, type=types.IntType, minval=-5000, maxval=5000, unit='mV')
...
############################
    ...
    def _get_param(self, regnum):
        ...
        err = self._spcm_win32.GetParam64(self._spcm_win32.handel, regnum, p_antw)
        if (err==0):
...
########################
    ...
    def do_get_ramsize(self):
        ...
        #print self._get_param(_spcm_regs.SPC_PCIMEMSIZE)
...
### set clock mode
    ...
    def set_clockmode_ext(self):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Set clock mode to external reference')
...
### timing
    ...
    def do_set_post_trigger(self, posttrigger):
        ...
        after the trigger event. Has to be at least 32.
        ...
        '''
        if posttrigger < 32:
            logging.warning(__name__ + ' : post trigger has to be at least 32. I fix this.')
            posttrigger = 32
