...
class Tuning(mb.MeasureBase):
    ...
    def set_z_parameters(self, vec, coordname, set_obj, unit, dt=None):
        ...
        In a 3D measurement, the x-parameters will be the "outer" sweep meaning for every x value all y values
        are swept and for each (x,y) value the bias is swept according to the set sweep parameters.
