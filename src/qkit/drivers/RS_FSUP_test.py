...
# modified: Jonas N. Kaemmerer <jonas.kaemmerer@kit.edu> 03/26
#
...
class RS_FSUP_test(Instrument):
    ...
    Usage:
    Initialise with
    <name> = instruments.create('<name>','RS_FSUP', address='<TCPIP address>' )
    ...
    def __init__(self, name, address, channel_index = 1):
        ...
        self.add_function('enable_marker')
    ...
    def reset(self):
        self.write("*CLS") # Reset status register
        self.write("*RST") # Reset instrument
    ...
    def get_trace(self, tracenumber=1):
        ...
        return self._visainstrument.query_ascii_values(
                                'TRAC%i? TRACE%i'%(tracenumber, tracenumber) ,
    ...
    def start_measurement(self):
        ...
        duration = self.get_sweeptime_averages()
        self._visainstrument.timeout = int( 10 * duration * 1000 )
    ...
    def get_tracedata(self,tracenumber=1):
        ...
        return self.get_trace(tracenumber)
