...
#define refresh_rate        50000     'sampling frequency of sweep process. (MCU_frequency / sweep_processdelay)
#define MCU_frequency       300E6     'Processor frequency
#define sweep_processdelay  6000      'must be high enough to don't overload ADwin.
